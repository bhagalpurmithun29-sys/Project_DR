...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] font-display text-slate-900 antialiased overflow-x-hidden">
      {/* ── NAVBAR ── */}
      <motion.header
        initial={{ y: -100 }}
        animate={{ y: 0 }}
      ...
      <main>
        ...
        <section className="relative overflow-hidden px-6 py-20 lg:px-12 lg:py-32">
          <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/4 w-[800px] h-[800px] bg-primary/5 rounded-full blur-[120px] pointer-events-none animate-pulse" />
          <div className="absolute bottom-0 left-0 translate-y-1/2 -translate-x-1/4 w-[600px] h-[600px] bg-indigo-500/5 rounded-full blur-[100px] pointer-events-none" />
          ...
          >
            ...
            <div className="flex flex-1 flex-col items-start gap-8 relative z-10">
              ...
              <motion.div variants={itemVariants} className="flex flex-wrap gap-4">
                <Link
                  to="/register"
                  className="flex h-16 items-center gap-3 rounded-2xl bg-primary px-10 text-lg font-black text-white shadow-2xl shadow-primary/30 transition-all hover:-translate-y-1 hover:shadow-primary/50 active:translate-y-0"
                >
                  <Upload size={20} />
                  Start Screening
                </Link>
            ...
            >
              <div className="relative group">
                ...
                <motion.div
                  ref={cardRef}
                  className="relative h-80 w-80 lg:h-[520px] lg:w-[520px] overflow-hidden rounded-full"
                  style={{
                    rotateY: tiltX,
                    rotateX: tiltY,
        ...
        {/* ── STATS ── */}
        <section className="bg-slate-900 py-24 px-6 lg:px-12 relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_50%,rgba(19,127,236,0.1),transparent_70%)]" />
        ...
        <section className="mx-auto max-w-7xl px-6 py-24 lg:px-12 lg:py-32">
          <motion.div
            ...
            className="relative overflow-hidden rounded-[4rem] bg-primary px-8 py-20 text-center lg:py-32 shadow-[0_40px_100px_-20px_rgba(19,127,236,0.5)]"
          >
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-20 pt-8 border-t border-slate-50 flex flex-col items-center justify-between gap-6 md:flex-row">
            <p className="text-sm font-bold text-slate-400">
              © 2024 RetinaAI Systems Inc. <span className="mx-2">/</span> HIPAA Compliant
            </p>
