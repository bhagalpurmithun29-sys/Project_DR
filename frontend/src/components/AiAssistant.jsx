...
const MessageBubble = ({ message }) => {
    ...
    return (
        ...
        >
            {/* Avatar */}
            <div className={`shrink-0 size-10 rounded-2xl flex items-center justify-center shadow-lg transition-transform hover:scale-110 ${
                isUser
            ...
            <div className={`max-w-[80%] flex flex-col ${isUser ? 'items-end' : 'items-start'}`}>
                <div className={`relative rounded-[2rem] px-6 py-4 shadow-2xl transition-all ${
                    isUser
